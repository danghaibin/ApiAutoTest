...
head = {
    "Cookie": 'SESSION=796fae18-ed57-4982-b0f9-8cfabfc6da26; '
              ...
              '__auc=d459fe061759c38afba5f8f1672; '
              'MEIQIA_TRACK_ID=1juAmY6kTltDOm2BU0zeSwPSvHC; '
              '_ga=GA1.2.392720944.1604643768; _gid=GA1.2.397703840.1604643768; '
              '__asc=d6501ea81759c8b18774d6b3610; '
              'MEIQIA_VISIT_ID=1juLjTtuPoBQvwTbGk4JFOP0d2G; '
              'BAGSESSIONID=38bb368d-a31b-4b6b-9572-417331c80063; '
              'JSESSIONID=E8EC8A6C9E3CD5253D7BADF81AE3830D; _gat=1; '
              'Hm_lpvt_1fc37bec18db735c69ebe77d923b3ab9=1604649198; '
              'BAG_EVENT_TOKEN_=02de735f68204d51009e7edda78e58c13a3fcdd1; '
              'BAG_EVENT_CK_KEY_="2780487875@qq.com"; '
...
'''
s = requests.session()  # 创建了一个session对象,通过session 发送请求
